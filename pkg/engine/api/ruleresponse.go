...
type RuleResponse struct {
	...
	// mutatePatches is the patches applied by the mutate rule
	mutatePatches [][]byte
...
func (r RuleResponse) WithMutatePatches(patches [][]byte) *RuleResponse {
	r.mutatePatches = patches
	return &r
}
...
func (r *RuleResponse) MutatePatches() [][]byte {
	return r.mutatePatches
}
...
func (r *RuleResponse) HasMutatePatch() bool {
	return len(r.mutatePatches) != 0
}
