...
func (v *mutationHandler) applyMutations(
	...
	patches := make([][]byte, 0, len(policies))
...
func (h *mutationHandler) applyMutation(ctx context.Context, request admissionv1.AdmissionRequest, policyContext *engine.PolicyContext, failurePolicy kyvernov1.FailurePolicyType) (*engineapi.EngineResponse, [][]byte, error) {
	...
	return &engineResponse, engineResponse.GetPatchBytes(), nil
}
